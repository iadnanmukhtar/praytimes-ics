...
//	}
	...
	private double[] computeTimes(double[] times) {
		...
		double Fajr = this.computeTime(180 - methodParams.get(this
				.getCalcMethod())[0], t[0]);
		...
		double Maghrib = this.computeTime(methodParams
				.get(this.getCalcMethod())[2], t[5]);
